...
module.exports = class S3ZipModifier {
    async loadFromS3(s3LocationParams = {}) {
    ...
    async saveToS3(options = {}) {
        ...
        const destBucket = options.bucket || this.s3LocationParams.destBucket || this.s3LocationParams.bucket;
        const destKey = options.key || this.s3LocationParams.destKey || `${this.s3LocationParams.key}_modified`;
